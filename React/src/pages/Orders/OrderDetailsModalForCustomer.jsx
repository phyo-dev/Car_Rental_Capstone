...
const OrderDetailsModalForCustomer = ({ show, handleClose, order, onCancel }) => {
    ...
    return (
        <Modal
            ...
            onCancel={handleClose}
            footer={[
                <Button key="deny" onClick={handleCancel} danger disabled={order.status == 'PENDING' ? false : true}>
                    Cancel
                </Button>,
            ]}
            centered
